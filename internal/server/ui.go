...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Mailbag</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Mailbag</h1>
    <p>Transactional email service — SMTP relay with dashboard, templates, delivery tracking</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">1 SMTP config, 500 sends/mo</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited configs, unlimited sends</div>
